...
(function (pxt) {
    ...
    (function (blocks_1) {
        ...
        blocks_1.getTopLevelParent = getTopLevelParent;
            ...
            Blockly.Functions.flyoutCategory = function (workspace) {
                ...
                var _loop_1 = function (e) {
                    ...
                    if (e.getAttribute("type") === "function_call") {
                        ...
                        if (mutation) {
                            var name_7 = mutation.getAttribute("name");
                            if (functionsWithReturn.some(function (n) { return n === name_7; })) {
            ...
            DestructuringMutator.prototype.updateVisibleProperties = function () {
                ...
                this.currentlyVisible.forEach(function (param) {
                    if (_this.parameters.indexOf(param) === -1) {
                        var name_8 = _this.getVarFieldValue(param);
                        // Persist renames
                        if (name_8 !== param) {
                            _this.parameterRenames[param] = name_8;
                        }
...
(function (pxtblockly) {
    ...
    var FieldTileset = /** @class */ (function (_super) {
        ...
        FieldTileset.rebuildTileCache = function (ws, blocksInfo) {
            ...
            var _loop_9 = function (galleryRef) {

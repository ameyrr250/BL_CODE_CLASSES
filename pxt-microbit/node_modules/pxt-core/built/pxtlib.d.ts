...
declare namespace pxt.BrowserUtils {
    ...
    function isLocalHost(ignoreFlags?: boolean): boolean;
    ...
    function getPageX(event: any): number;
    function getPageY(event: any): number;
...
declare namespace pxt.commands {
    ...
    let renderBrowserDownloadInstructions: () => any;
...
declare namespace pxt.github {
    ...
    let handleGithubNetworkError: (e: any) => boolean;
...
declare namespace pxt.HF2 {
    ...
    function mkPacketIOWrapper(io: pxt.packetio.PacketIO): pxt.packetio.PacketIOWrapper;
...
declare namespace pxt.packetio {
    ...
    function configureEvents(onConnectionChanged: () => void, onSerial: (buf: Uint8Array, isStderr: boolean) => void): void;
...
declare namespace pxt.sprite {
    ...
    function decodeTilemap(literal: string, fileType: "typescript" | "python"): TilemapData;
    ...
    function tileToBlocklyVariable(info: pxt.sprite.TileInfo): string;
    function blocklyVariableToTile(name: string): pxt.sprite.TileInfo;
}
...
declare namespace pxt.usb {
    ...
    function mkPacketIOAsync(): Promise<pxt.packetio.PacketIO>;
...
declare namespace pxt.Cloud {
    ...
    function apiRequestWithCdnAsync(options: Util.HttpRequestOptions): Promise<any>;

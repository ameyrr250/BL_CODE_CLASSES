...
function hf2ConnectAsync(path, raw) {
    ...
    h.rawMode = raw;
    return h.reconnectAsync().then(function () { return h; });
}
...
var HidIO = /** @class */ (function () {
    ...
    HidIO.prototype.setConnecting = function (v) {
    ...
    HidIO.prototype.disposeAsync = function () {
        return Promise.resolve();
    };
    HidIO.prototype.isConnecting = function () {
        return this.connecting;
    };
    HidIO.prototype.isConnected = function () {
        return !!this.dev;
    };

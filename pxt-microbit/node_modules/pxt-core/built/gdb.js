...
function getOpenOcdPath(cmds, showLog) {
    if (cmds === void 0) { cmds = ""; }
...
function flashAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var r, toolPaths, oargs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    r = pxtc.UF2.toBin(fs.readFileSync("built/binary.uf2"));
                    ...
                    return [4 /*yield*/, nodeutil.spawnAsync({
                            cmd: oargs[0],
                            args: oargs.slice(1)
                        })];
                case 1:
...
function resetAsync(bootMode) {
    return __awaiter(this, void 0, void 0, function () {
        var bi, cmd, toolPaths, oargs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bi = getBootInfo();
                    if (!gdbServer) return [3 /*break*/, 4];
                    if (!(bootMode && bi.addr)) return [3 /*break*/, 2];
                ...
                case 4:
                    ...
                    cmd += "reset run\nshutdown";
                    toolPaths = getOpenOcdPath(cmd, true);
                    oargs = toolPaths.args;
                    return [4 /*yield*/, nodeutil.spawnAsync({
                            cmd: oargs[0],
                            args: oargs.slice(1)
...
function getMemoryAsync(addr, bytes) {
    return __awaiter(this, void 0, void 0, function () {
        var maxMem, bufs, ptr, _a, _b, toolPaths, oargs, res, buf, _i, _c, line, m;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    maxMem = 32 * 1024;
                    if (!(bytes > maxMem)) return [3 /*break*/, 5];
                    bufs = [];
                    ptr = 0;
                    _d.label = 1;
                case 1:
                    if (!(ptr < bytes)) return [3 /*break*/, 4];
                    _b = (_a = bufs).push;
                    return [4 /*yield*/, getMemoryAsync(addr + ptr, Math.min(maxMem, bytes - ptr))];
                case 2:
                    _b.apply(_a, [_d.sent()]);
                    _d.label = 3;
                case 3:
                    ptr += maxMem;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, Buffer.concat(bufs)];
                case 5:
                ...
                case 6:
                    ...
                    for (_i = 0, _c = res.toString("utf8").split(/\r?\n/); _i < _c.length; _i++) {
                        line = _c[_i];
...
function dumpMemAsync(args) {
    return __awaiter(this, void 0, void 0, function () {
        var memStart, memEnd, mem;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function dumpheapAsync(filename) {
    return __awaiter(this, void 0, void 0, function () {
        function mark(src, r) {
        ...
        var memStart, memEnd, mem, buf, heapDesc, m, heapSz, heapNum, vtablePtrs, pointerClassification, numFibers, numListeners, _i, _a, q, addr, ptr, messageBus, ptr, ptr, ptr, cnts, fiberSize, i, heapStart, heapEnd, block, totalFreeBlock, totalUsedBlock, bp, blockSize, isFree, classification, mark_1, keys, _b, keys_1, k, uf2, currClass, classMap, inIface, classInfo, _c, _d, line, m_1, objects, byCategory, numByCategory, maxFree, string_inline_ascii_vt, string_inline_utf8_vt, string_cons_vt, string_skiplist16_vt, PNG, visWidth, visHeight, heapVis, visData, i, gcHeap, heapSize, objPtr, heapEnd, fields, vtable, numbytes, category, addWords, color, classification, vt0, objectType, classNoEtc, classNo, word0, tmp, len, i, i, i, cinfo, i, i, numwords, obj, i, j, mask, cats, fidx, _e, cats_1, c, dmesg, roots, _f, _g, rootId, _h, _j, f, unreachable, _k, _l, o, dgml, _m, _o, addr, obj, _p, _q, addr, obj, _r, _s, fieldaddr, field;
        return __generator(this, function (_t) {
            switch (_t.label) {
                case 0:
                    ...
                    return [3 /*break*/, 4];
                case 1: return [4 /*yield*/, initGdbServerAsync()];
                case 2:
                    _t.sent();
                    return [4 /*yield*/, getMemoryAsync(memStart, memEnd - memStart)];
                case 3:
                ...
                case 4:
                    ...
                    visWidth = 256;
                    visHeight = 256;
                    heapVis = new PNG({ width: visWidth, height: visHeight });
                    visData = heapVis.data;
                    for (i = 0; i < visWidth * visHeight * 4; ++i)
                        visData[i] = 0xff;
                    /*
                    struct VTable {
                        uint16_t numbytes;
                    ...
                    for (gcHeap = read32(findAddr("pxt::firstBlock")); gcHeap; gcHeap = read32(gcHeap)) {
                        ...
                        while (objPtr < heapEnd) {
                            ...
                            for (i = 0; i < numwords; ++i) {
                                j = (objPtr & 0xffffff) + i * 4;
                                if (category == "free") {
                                    mask = Math.min(i / 1, 255) | 0;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    switch (_a) {
                        ...
                        case "dmesg": return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 8];
                case 2: return [4 /*yield*/, resetAsync(false)];
                case 3:
                    _b.sent();
                    return [3 /*break*/, 8];
                case 4: return [4 /*yield*/, resetAsync(true)];
                case 5:
                    _b.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, dumplogAsync()];
                case 7:
                    _b.sent();
                    return [3 /*break*/, 8];
...
function startAsync(gdbArgs) {
    return __awaiter(this, void 0, void 0, function () {
        var elfFile, bmpPort, trg, monReset, monResetHalt, pyOCD, mapsrc, toolPaths, oargs, binfo, goToApp, goToBl, gdbargs, proc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    elfFile = codalBin();
                ...
                case 1:
                    ...
                    if (!(gdbArgs[0] == "flash")) return [3 /*break*/, 3];
                    return [4 /*yield*/, flashAsync()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
                case 3:

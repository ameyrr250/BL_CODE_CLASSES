...
declare namespace pxt.blocks {
    ...
    function findBlockIdByPosition(sourceMap: BlockSourceInterval[], loc: {
        start: number;
        length: number;
    }): string;
    function findBlockIdByLine(sourceMap: BlockSourceInterval[], loc: {
        start: number;
        length: number;
    }): string;
    function getTopLevelParent(block: Blockly.Block): Blockly.Block;
...
declare namespace pxt.blocks {
    ...
    function needsDecompiledDiff(oldXml: string, newXml: string): boolean;
    ...
    function decompiledDiffAsync(oldTs: string, oldResp: pxtc.CompileResult, newTs: string, newResp: pxtc.CompileResult, options?: DiffOptions): DiffResult;
}
declare namespace pxt.blocks {
    /**
...
declare namespace pxt.blocks.layout {
    ...
    function setCollapsedAll(ws: Blockly.WorkspaceSvg, collapsed: boolean): void;
...
declare namespace pxt.blocks {
    ...
    interface GrayBlock extends Blockly.Block {
        setPythonEnabled(enabled: boolean): void;
    }
    interface GrayBlockStatement extends GrayBlock {
    ...
    let onShowContextMenu: (workspace: Blockly.Workspace, items: Blockly.ContextMenu.Option[]) => void;
    /**
    ...
    function mkReturnStatementBlock(): HTMLElement;
...
declare namespace pxt.blocks {
    ...
    function initReturnStatement(b: Blockly.Block): void;
}
...
declare namespace pxtblockly {
    ...
    class FieldNote extends Blockly.FieldNumber implements Blockly.FieldCustom {
         ...
         */
        doClassValidation_(text: string): string;
        /**
...
declare namespace pxtblockly {
    interface FieldTilemapOptions {
        initWidth: string;
        initHeight: string;
        filter?: string;
    }
    class FieldTilemap extends Blockly.Field implements Blockly.FieldCustom {
        isFieldCustom_: boolean;
        SERIALIZABLE: boolean;
        private params;
        private blocksInfo;
        ...
        render_(): void;
        getValue(): string;
        getTileset(): pxt.sprite.TileSet;
        doValueUpdate_(newValue: string): void;
        redrawPreview(wsTiles?: pxt.sprite.TileInfo[]): void;
        private parseBitmap;
        protected initState(): void;
        protected updateWorkspaceTiles(tileset: pxt.sprite.TileSet): void;
        protected restoreTilesFromWorkspace(tilemap: pxt.sprite.TilemapData, wsTiles?: pxt.sprite.TileInfo[]): void;
...
declare namespace pxtblockly {
    ...
    type TilesetDropdownOption = [ImageJSON, string];
    class FieldTileset extends FieldImages implements Blockly.FieldCustom {
        private static tileCache;
        private static galleryTiles;
        static rebuildTileCache(ws: Blockly.Workspace, blocksInfo: pxtc.BlocksInfo): void;
        static getTileKey(t: pxt.sprite.TileInfo): string;
        static getTileImage(t: pxt.sprite.TileInfo, ws: Blockly.Workspace, blocksInfo: pxtc.BlocksInfo): string;
        static getTileImageJSON(t: pxt.sprite.TileInfo, ws: Blockly.Workspace, blocksInfo: pxtc.BlocksInfo): {
            src: string;
            width: number;
            height: number;
            alt: string;
        };
        static getGalleryTiles(): TilesetDropdownOption[];
        isFieldCustom_: boolean;
        ...
        constructor(text: string, options: FieldImageDropdownOptions, validator?: Function);
        init(): void;
        menuGenerator_: () => TilesetDropdownOption[];
    }
}
declare namespace pxtblockly {
    class FieldToggle extends Blockly.FieldNumber implements Blockly.FieldCustom {
        ...
        getMaxLength(): number;
        getOutputShape(): any;
        doClassValidation_(newBool: string): string;
        applyColour(): void;
        /**
         * Return 'TRUE' if the toggle is ON, 'FALSE' otherwise.
         * @return {string} Current state.
...
declare namespace pxtblockly {
    ...
    function tilemapToImageURI(data: pxt.sprite.TilemapData, sideLength: number, lightMode: boolean, blocksInfo: pxtc.BlocksInfo): string;
    function saveTilesetTile(ws: Blockly.Workspace, tile: pxt.sprite.TileInfo): void;
    function deleteTilesetTileIfExists(ws: Blockly.Workspace, tile: pxt.sprite.TileInfo): void;
    function getAllTilesetTiles(ws: Blockly.Workspace): pxt.sprite.TileInfo[];
    ...
    function getAllBlocksWithTilemaps(ws: Blockly.Workspace): FieldEditorReference<FieldTilemap>[];

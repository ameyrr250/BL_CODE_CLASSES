...
namespace LCD_Mini{
  ...
  export function createLCDSettings(boardID:BoardID, clickID:ClickID): LCDSettings {
      return new LCDSettings(boardID, clickID);
  }
...
export class LCDSettings{
      ...
      this.SPIs = new bBoard.SPIsetting(boardID, clickID);
      }
      ...
      //bBoard.clearPin(CS,boardID)
      this.SPIs.SPIWriteArray(cmd)
      //bBoard.setPin(CS,boardID)
      }
      ...
      let cmd = [0,val];
      // bBoard.clearPin(CS2,boardID)
      this.SPIs.spiCS(this.CS2)
      this.SPIs.SPIWriteArray(cmd)
      this.SPIs.spiCS(this.CS)
      //bBoard.setPin(CS2,boardID)
      }
